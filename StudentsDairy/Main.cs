using StudentsDairy.Properties;
using System;
...
namespace StudentsDairy
{
    public partial class Main : Form
    {
        ...
        {
            cbSortByGroup.DataSource = _groups;
            cbSortByGroup.DisplayMember = "Name";
            cbSortByGroup.ValueMember = "Id";
        }
        ...
        private void RefreshDiary()
        {
            ...
            var selectetGroupId = (cbSortByGroup.SelectedItem as Group).Id;

            if (selectetGroupId != 0)
                students = students.Where(x => x.GroupId == selectetGroupId).ToList();
        ...
        private void SetColumnsHeader()
        {
            ...
            dgvDiary.Columns[6].HeaderText = "Chemia";
            dgvDiary.Columns[7].HeaderText = "Biologia";
        ...
        private void delButton_Click(object sender, EventArgs e)
        {
            ...
            var confirmDelete = MessageBox.Show($"Czy napewno chcesz usunąć ucznia {(selectedStudent.Cells[1].Value.ToString() + " " + selectedStudent.Cells[2].Value.ToString()).Trim()}",
        ...
        private void cbSortByGroup_SelectedIndexChanged(object sender, EventArgs e)
        {
